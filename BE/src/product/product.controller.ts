...
export class ProductController {
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve all products in the system regardless of status. Requires manage_product permission.',
  })
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @RequirePermissions(Permission.MANAGE_PRODUCT)
  async getAllProductsManager(@Query() query: any, @Req() req: any) {
    return this.productservice.getAllProductsManager(query, req.user);
  }
  ...
  @ApiOperation({
    ...
    description:
      'Create a new makeup brand with logo upload. Requires manage_brands permission.',
  })
  ...
  @ApiResponse({
    status: 403,
    description: 'Forbidden - Requires manage_brands permission',
  })
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  ...
  @ApiOperation({
    ...
    description:
      'Delete an existing brand. Only possible if no products are using this brand. Requires manage_brands permission.',
  })
  @ApiParam({ name: 'brandId', description: 'Brand ID', type: Number })
  @ApiResponse({ status: 200, description: 'Brand deleted successfully' })
  @ApiResponse({
    status: 400,
    description: 'Bad request - Brand is being used by products',
  })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({
    status: 403,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve a list of all product categories including parent and child categories',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Create a new product category. Can be a parent category or subcategory.',
  })
  ...
  @ApiResponse({
    status: 403,
    description: 'Forbidden - Requires manage_categorys permission',
  })
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  ...
  @ApiResponse({
    status: 200,
    description: 'Category slug updated successfully',
  })
  @ApiResponse({ status: 400, description: 'Bad request - Missing slug field' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({
  ...
  @ApiOperation({
    ...
    description:
      'Delete an existing category. Only possible if no products are using this category and it has no child categories. Requires manage_categorys permission.',
  })
  @ApiParam({ name: 'categoryId', description: 'Category ID', type: Number })
  @ApiResponse({ status: 200, description: 'Category deleted successfully' })
  @ApiResponse({
    status: 400,
    description: 'Bad request - Category is being used or has children',
  })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({
    status: 403,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve a paginated list of products with optional filters for name, brand, category, publication status, and moderation status',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiQuery({
    ...
    required: false,
    type: String,
    description: 'General search (deprecated, use "name" instead)',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiResponse({
    status: 200,
    description: 'Returns user wishlist with product details',
  })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  ...
  @ApiResponse({
    status: 200,
    description: 'Returns user cart with product details',
  })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @UseGuards(JwtAuthGuard)
  ...
  @ApiOperation({
    ...
    description:
      "Add a product (with optional variant) to the authenticated user's cart",
  })
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve detailed information about a product with pending moderation status. Requires manage_product permission.',
  })
  @ApiParam({ name: 'productId', description: 'Product ID', type: Number })
  @ApiResponse({
    status: 200,
    description:
      'Returns pending product details with variants, images, and categories',
  })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({
    status: 403,
    description: 'Forbidden - Requires manage_product permission',
  })
  @ApiResponse({
    status: 404,
    description: 'Product not found or not in pending status',
  })
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @RequirePermissions(Permission.MANAGE_PRODUCT)
  ...
  @ApiOperation({
    ...
    description:
      'Change the moderation status of a product from pending to approved. Requires manage_product permission.',
  })
  @ApiParam({ name: 'productId', description: 'Product ID', type: Number })
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve product details using its URL-friendly slug. Only returns published and approved products.',
  })
  @ApiParam({
    name: 'slug',
  ...
  @ApiResponse({
    status: 200,
    description: 'Returns product details with variants, images, and reviews',
  })
  @ApiResponse({ status: 404, description: 'Product not found' })
  ...
  @ApiOperation({
    ...
    description: 'Increments the view count for a product.',
  })
  @ApiParam({ name: 'productId', description: 'Product ID', type: Number })
  async recordProductView(@Param('productId', ParseIntPipe) productId: number) {
    return this.productservice.recordProductView(productId);
  }
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve product details using its ID. Only returns published and approved products.',
  })
  @ApiParam({ name: 'productId', description: 'Product ID', type: Number })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve product details for management purposes. Includes unpublished and pending products. Requires manage_product permission.',
  })
  @ApiParam({ name: 'productId', description: 'Product ID', type: Number })
  @ApiResponse({
    status: 200,
    description: 'Returns complete product details including all statuses',
  })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({
    status: 403,
    description:
      'Forbidden - Requires manage_product permission or product ownership',
  })
  @ApiResponse({ status: 404, description: 'Product not found' })
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @RequirePermissions(Permission.MANAGE_PRODUCT)
  ...
  @ApiOperation({
    ...
    description:
      'Create a new product for a shop. Requires manage_product permission.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Update an existing product. Requires manage_product permission and product ownership.',
  })
  @ApiParam({ name: 'productId', description: 'Product ID', type: Number })
  ...
  @Post(':productId/restore-request')
  @ApiBearerAuth('JWT-auth')
  @ApiOperation({
    summary: 'Request admin approval to restore a soft-deleted product',
    description:
      'Shop owner or staff with manage_product can request admin approval to restore a soft-deleted product.',
  })
  @ApiParam({ name: 'productId', description: 'Product ID', type: Number })
  @ApiBody({
    required: false,
    schema: {
      ...
      properties: {
        note: {
          type: 'string',
          description: 'Optional note for admin',
        },
      },
    },
  })
  @ApiResponse({ status: 200, description: 'Restore request submitted' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({
    status: 403,
    description: 'Forbidden - No permission to request restore',
  })
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @RequirePermissions(Permission.MANAGE_PRODUCT)
  async requestProductRestore(
    @Param('productId', ParseIntPipe) productId: number,
    @Body() body: { note?: string },
    @Req() req: any,
  ) {
    const userId = req.user.userId;
    return this.productservice.requestProductRestore(
      productId,
      userId,
      body?.note,
    );
  ...
  @ApiOperation({
    ...
    description:
      'Soft-delete an existing product. Admin can delete any product; shop owner or staff with manage_product can delete products in their shop. Products with orders cannot be deleted.',
  })
  @ApiParam({ name: 'productId', description: 'Product ID', type: Number })
  ...
  @ApiResponse({
    status: 403,
    description: 'Forbidden - No permission to delete this product',
  })
  @ApiResponse({ status: 404, description: 'Product not found' })
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @RequirePermissions(Permission.MANAGE_PRODUCT)
  ...
  @ApiOperation({
    ...
    description:
      'Create a new variant for a product (e.g., different colors, sizes). Requires manage_product permission.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Update an existing product variant. Requires manage_product permission.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Delete an existing product variant. Requires manage_product permission.',
  })
  @ApiParam({ name: 'variantId', description: 'Variant ID', type: Number })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Upload an image or video for a product. Requires manage_product permission.',
  })
  @ApiConsumes('multipart/form-data')
  @ApiParam({ name: 'productId', description: 'Product ID', type: Number })
  @ApiBody({
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve all products from a specific shop with pagination and filters',
  })
