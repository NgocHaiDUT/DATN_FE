...
export class UsersController {
  ...
  @ApiOperation({
    ...
    description:
      'Create a new user with optional avatar upload. Avatar file should be sent as multipart/form-data with field name "avatar"',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Update user information including optional avatar upload to S3. Send avatar as multipart/form-data with field name "avatar"',
  })
  @ApiConsumes('multipart/form-data')
  @ApiBody({
    schema: {
      ...
      properties: {
        ...
        avatar: {
          ...
          format: 'binary',
          description:
            'Avatar image file (JPG, PNG, GIF, HEIC, HEIF, WebP, max 5MB)',
        },
      },
    },
  })
  ...
  @ApiOperation({
    ...
    description:
      'Update user avatar by uploading a new image file. Supports both S3 and local storage based on configuration.',
  })
  @ApiConsumes('multipart/form-data')
  @ApiBody({
    schema: {
