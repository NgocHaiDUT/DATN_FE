...
export class AnalyticsController {
  ...
  async getAdminRevenueDetails(
    ...
    return this.analyticsService.getAdminRevenueDetails(req.user.userId, query);
  }

  // Per-product views, tryon and sales stats for seller
  @Get('shop/:shopId/products/stats')
