-- CreateEnum
CREATE TYPE "public"."user_role" AS ENUM ('user', 'seller', 'admin', 'staff');
...
-- CreateEnum
CREATE TYPE "public"."product_moderation_status" AS ENUM ('pending', 'approved', 'rejected', 'removed');

-- CreateEnum
CREATE TYPE "public"."skin_type" AS ENUM ('unknown', 'normal', 'oily', 'dry', 'combination', 'sensitive');

-- CreateEnum
CREATE TYPE "public"."message_type" AS ENUM ('TEXT', 'IMAGE', 'VIDEO', 'SHARE_POST', 'SHARE_PRODUCT', 'SHARE_PROFILE', 'STORY_REPLY');
...
-- CreateTable
CREATE TABLE "public"."device_otps" (
    "id" SERIAL NOT NULL,
    "user_id" INTEGER NOT NULL,
    ...
    CONSTRAINT "device_otps_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "public"."oauth_login_codes" (
    ...
    CONSTRAINT "oauth_login_codes_pkey" PRIMARY KEY ("code")
);
...
CREATE TABLE "public"."products" (
    ...
    "description" TEXT,
    "how_to_use" TEXT,
    "moderation_status" "public"."product_moderation_status" NOT NULL DEFAULT 'pending',
...
CREATE TABLE "public"."orders" (
    ...
    "updated_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "ghn_order_code" TEXT,
    "ghn_expected_delivery_time" TIMESTAMP(3),
    "ghn_required_note" TEXT,
    "shipping_payer" TEXT,
...
CREATE TABLE "public"."shop_follows" (
    ...
    CONSTRAINT "shop_follows_pkey" PRIMARY KEY ("user_id","shop_id")
);
...
CREATE TABLE "public"."messages" (
    ...
    "conversation_id" INTEGER NOT NULL,
    "sender_id" INTEGER,
    "sender_shop_id" INTEGER,
    "sender_type" TEXT,
    "type" "public"."message_type" NOT NULL DEFAULT 'TEXT',
    "content" TEXT,
    "post_id" INTEGER,
    "shared_profile_id" INTEGER,
...
-- CreateIndex
CREATE INDEX "device_otps_user_id_device_id_idx" ON "public"."device_otps"("user_id", "device_id");

-- CreateIndex
CREATE INDEX "device_otps_expires_at_idx" ON "public"."device_otps"("expires_at");

-- CreateIndex
CREATE UNIQUE INDEX "refresh_tokens_token_key" ON "public"."refresh_tokens"("token");

-- CreateIndex
CREATE INDEX "refresh_tokens_user_id_device_id_idx" ON "public"."refresh_tokens"("user_id", "device_id");

-- CreateIndex
CREATE UNIQUE INDEX "refresh_tokens_user_id_device_id_key" ON "public"."refresh_tokens"("user_id", "device_id");

-- CreateIndex
CREATE INDEX "oauth_login_codes_user_id_idx" ON "public"."oauth_login_codes"("user_id");

-- CreateIndex
CREATE INDEX "oauth_login_codes_code_idx" ON "public"."oauth_login_codes"("code");

-- CreateIndex
CREATE INDEX "oauth_login_codes_expires_at_idx" ON "public"."oauth_login_codes"("expires_at");
...
-- CreateIndex
CREATE INDEX "posts_is_story_idx" ON "public"."posts"("is_story");

-- CreateIndex
CREATE INDEX "posts_expires_at_idx" ON "public"."posts"("expires_at");

-- CreateIndex
CREATE INDEX "posts_user_id_is_story_idx" ON "public"."posts"("user_id", "is_story");
...
-- CreateIndex
CREATE INDEX "chatbot_sessions_user_id_idx" ON "public"."chatbot_sessions"("user_id");

-- CreateIndex
CREATE INDEX "chatbot_sessions_coze_conversation_id_idx" ON "public"."chatbot_sessions"("coze_conversation_id");

-- CreateIndex
CREATE INDEX "chatbot_messages_session_id_idx" ON "public"."chatbot_messages"("session_id");

-- CreateIndex
CREATE INDEX "story_views_post_id_idx" ON "public"."story_views"("post_id");

-- CreateIndex
CREATE INDEX "story_views_viewer_id_idx" ON "public"."story_views"("viewer_id");

-- CreateIndex
CREATE UNIQUE INDEX "story_views_post_id_viewer_id_key" ON "public"."story_views"("post_id", "viewer_id");
...
-- AddForeignKey
ALTER TABLE "public"."device_otps" ADD CONSTRAINT "device_otps_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."refresh_tokens" ADD CONSTRAINT "refresh_tokens_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."oauth_login_codes" ADD CONSTRAINT "oauth_login_codes_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."shop_addresses" ADD CONSTRAINT "shop_addresses_shop_id_fkey" FOREIGN KEY ("shop_id") REFERENCES "public"."shops"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."shop_follows" ADD CONSTRAINT "shop_follows_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."shop_follows" ADD CONSTRAINT "shop_follows_shop_id_fkey" FOREIGN KEY ("shop_id") REFERENCES "public"."shops"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."saved_posts" ADD CONSTRAINT "saved_posts_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."saved_posts" ADD CONSTRAINT "saved_posts_post_id_fkey" FOREIGN KEY ("post_id") REFERENCES "public"."posts"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."chatbot_sessions" ADD CONSTRAINT "chatbot_sessions_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."chatbot_messages" ADD CONSTRAINT "chatbot_messages_session_id_fkey" FOREIGN KEY ("session_id") REFERENCES "public"."chatbot_sessions"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."story_views" ADD CONSTRAINT "story_views_post_id_fkey" FOREIGN KEY ("post_id") REFERENCES "public"."posts"("id") ON DELETE CASCADE ON UPDATE CASCADE;
